...
export const DATA = {
  ...
  projects: [
    ...
    {
      title: "TrustGraph",
      href: "https://github.com/joshuahsieh24/TrustGraph",
      target: "_blank",
      rel: "noopener noreferrer",
      dates: "April 2026",
      active: true,
      description:
        "Behavioral intelligence platform for zero-trust access control. Models session activity across users, devices, and apps — scoring each session with a hybrid ML pipeline, propagating risk through a live force-directed graph, and surfacing explainable policy recommendations with per-signal evidence.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Python",
    ...
    },
    {
      ...
      active: true,
      description:
        "Private film journal built around semantic memory, not ratings. Each entry ties to a life chapter with open reflection fields. An ML resurfacing engine — drawing on pgvector embeddings, K-means clusters, and temporal signals — surfaces films back when they're most likely to mean something.",
      technologies: [
        "Next.js",
        "FastAPI",
        "PostgreSQL",
    ...
    {
      title: "Postcard",
      href: "https://github.com/joshuahsieh24/postcard",
      target: "_blank",
      rel: "noopener noreferrer",
      dates: "March 2026",
      active: true,
      description:
        "Android time-capsule app. Write letters to your future self, seal them on creation, and receive a scheduled notification on delivery day — 1 week, 1 month, 1 year, or custom date. Deliveries survive app kills and device reboots via WorkManager.",
      technologies: [
        "Kotlin",
        "Jetpack Compose",
        "Room",
